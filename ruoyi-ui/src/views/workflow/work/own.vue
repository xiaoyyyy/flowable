<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="ownProcessList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="流程编号" align="center" prop="businessKey" :show-overflow-tooltip="true"/>
      <el-table-column label="流程名称" align="center" prop="procInstanceName" :show-overflow-tooltip="true"/>
