<template>
  <div class="process-panel__container" :style="{ width: `${this.width}px` }">
    <el-collapse v-model="activeTab">
      <el-collapse-item name="nodeConfig" v-if="elementType === 'UserTask'" key="nodeConfig">
        <div slot="title" class="panel-tab__title"><i class="el-icon-s-operation"></i>流程节点配置</div>
        <user-task-node-config :id="elementId" :type="elementType" />
      </el-collapse-item>
...
import UserTaskNodeConfig from "./node-config/UserTaskNodeConfig";
/**
 * 侧边栏
 * @Author MiyueFE
...
export default {
  ...
  watch: {
    elementId: {
      handler() {
        this.activeTab = this.elementType === "UserTask" ? "nodeConfig" : "base";
      }
    }
  },
  created() {
