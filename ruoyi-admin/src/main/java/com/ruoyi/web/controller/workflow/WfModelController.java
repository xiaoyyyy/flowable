...
public class WfModelController extends BaseController {
    ...
    @RepeatSubmit()
    @PostMapping("/deploy/{tenantId}")
    public R<Void> deployModel(@RequestParam String modelId, @PathVariable String tenantId) {
        return toAjax(modelService.deployModel(modelId, tenantId));
    }
